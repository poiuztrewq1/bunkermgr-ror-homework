...
class InventoryItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory_item" do
    assert_difference('InventoryItem.count') do
      post inventory_items_url, params: { inventory_item: { exp_date: @inventory_item.exp_date, food_type: @inventory_item.food_type, nutrition_per_unit: @inventory_item.nutrition_per_unit, quantity: @inventory_item.quantity } }
    end
