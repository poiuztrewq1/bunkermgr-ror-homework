class InventoryItemsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html {  redirect_to request.referrer || inventory_items_url, notice: 'Inventory item was successfully destroyed.' }
  ...
  def require_bunker_id
    redirect_to inventory_items_url, alert: 'You need to set a bunker to create an item' unless params.has_key?(:bunker_id)
  end
